...
/**
 * Date 2021/3/4 10:21 AM
 *
 * @author Tson
 */
class TLRCalculator {
    private static final String TAG = "TLRCalculator";
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        Log.v(TAG, "isKeepHeadRefreshing = " + isKeepHeadRefreshing);
        Log.v(TAG, "isKeepFootLoading = " + isKeepFootLoading);
        Log.v(TAG, "mRefreshMaxMoveDistance = " + mRefreshMaxMoveDistance);
        Log.v(TAG, "mLoadMaxMoveDistance = " + mLoadMaxMoveDistance);
    }
    ...
    private void moveOffsetY(int y) {
        ...
        //notify offset
        if (mTotalOffsetY > 0 && mStatusController.getLoadStatus() == TLRLinearLayout.LoadStatus.IDLE) {
            notifyPixOffset(mTotalOffsetY, refreshThresholdHeight, y);
        }
        if (mTotalOffsetY < 0 && mStatusController.getRefreshStatus() == TLRLinearLayout.RefreshStatus.IDLE) {
    ...
    public void startAutoRefresh() {
        Log.d(TAG, "autoRefresh mHeadHeight:" + mHeadHeight);
            ...
            tLRLinearLayout.getViewTreeObserver().addOnGlobalLayoutListener(
                    new ViewTreeObserver.OnGlobalLayoutListener() {
                        ...
                        public void onGlobalLayout() {
                            Log.d(TAG, "autoRefresh onGlobalLayout mHeadHeight:" + mHeadHeight);
        ...
        if (mHeadHeight != 0) {
            ...
            mAutoAnimator.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    Log.v(TAG, "startAutoRefreshAnimator isKeepHeadRefreshing:"
    ...
    private void startKeepAnimator() {
        ...
        if (DEBUG) {
            Log.d(TAG, "startKeepAnimator startY:" + startY + " endY:" + endY);
        }
